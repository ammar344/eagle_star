...
$show = "SELECT * FROM subscribes ORDER BY dated DESC";
        ...
        <?php include_once ('./includes/header.php'); ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Subscribes</span></h4>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="server.php?deleteSubId=<?php echo $subId ?>"
