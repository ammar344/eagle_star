...
if (isset($_REQUEST['signIn'])) {
  ...
  $login = "SELECT * FROM admin_users WHERE userEmail=? OR userName=?";
  ...
  if ($result->num_rows > 0) {
      ...
      // Verify the password
      if (password_verify($userPassword, $user['userPass'])) {
          // Password is correct
...
>
  <head>
    ...
    <title>Login Admin | Eagle Star</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Eagle Star Admin! 👋</h4>
